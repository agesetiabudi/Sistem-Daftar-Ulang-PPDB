            ...
            <div class="card card-custom mb-5">
                <div class="card-header flex-wrap py-5">
                    <div class="card-title">
                        <h3 class="card-label">Tahun Pelajaran Cms
                        <span class="d-block text-muted pt-2 font-size-sm">Data Tahun Pelajaran</span></h3>
                    </div>
                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <a href="{{ route('admin.tahun-pelajaran.create') }}" class="btn btn-primary font-weight-bolder">
                ...
                },
                {
                    ...
                    render: (id) => /* html */`
                            <div class="text-center">
                                <a href="/wpa-admin/tahun-pelajaran/edit/${id}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
            ...
            $('body').on('click', '.deleteProduct', function () {
                ...
                swalWithBootstrapButtons.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                        method: "GET",
                        url: "/wpa-admin/tahun-pelajaran" + '/' + product_id,

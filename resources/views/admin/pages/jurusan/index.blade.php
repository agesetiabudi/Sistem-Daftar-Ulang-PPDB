            ...
            <div class="card card-custom mb-5">
                <div class="card-header flex-wrap py-5">
                    <div class="card-title">
                        <h3 class="card-label">Program Keahlian
                        <span class="d-block text-muted pt-2 font-size-sm">Data Program Keahlian</span></h3>
                    </div>
                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <a href="{{ route('admin.jurusan.create') }}" class="btn btn-primary font-weight-bolder">
...
@push('script')
    ...
    <script>
        $(function(){
            ...
            serverSide: true,
            responsive: true,
            ajax: "{{ route('admin.jurusan.index') }}",
            columns: [
                {
                ...
                {
                    data: 'image',
                    render: function (data, type, row) { return "<img src='/image/jurusan/"+row.image+"' width='100'>" },
                },
                {
                    data: 'name',
                    name: 'name',
                },
                {
                    ...
                    render: (id) => /* html */`
                            <div class="text-center">
                                <a href="/wpa-admin/jurusan/edit/${id}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
            ...
            $('body').on('click', '.deleteProduct', function () {
                ...
                swalWithBootstrapButtons.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                        method: "GET",
                        url: "/wpa-admin/jurusan" + '/' + product_id,
                        success: function (data) {
                            table.ajax.reload();
                            swalWithBootstrapButtons.fire(
                            'Berhasil!',
                            'Berhasil Menghapus Program Keahlian',
                            'success'
                            )
                        },
                        error: function (data) {
                            ...
                            swalWithBootstrapButtons.fire(
                            'Gagal!',
                            'Gagal Menghapus Program Keahlian.',
                            'error'
                            )
                        }
                        });

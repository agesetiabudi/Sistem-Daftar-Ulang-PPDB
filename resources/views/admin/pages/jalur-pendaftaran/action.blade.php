        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12">
                    @if ($data)
                    <form class="form" method="POST" action="{{ route('admin.jalur-pendaftaran.update', $data->id) }}" enctype="multipart/form-data">
                        {{ method_field('PUT') }}    
                        @else
                        <form class="form" method="POST" action="{{ route('admin.jalur-pendaftaran.store') }}" enctype="multipart/form-data">
                            @endif
                            @csrf                        
                            <div class="card card-custom card-stretch">
                                ...
                                <div class="card-header py-3">
                                    <div class="card-title align-items-start flex-column">
                                        <h3 class="card-label font-weight-bolder text-dark">Jalur Pendaftaran</h3>
                                    </div>

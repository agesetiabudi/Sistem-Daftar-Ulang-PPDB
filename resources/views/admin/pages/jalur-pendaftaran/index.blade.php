            ...
            <div class="card card-custom mb-5">
                <div class="card-header flex-wrap py-5">
                    <div class="card-title">
                        <h3 class="card-label">Jalur Pendaftaran Cms
                        <span class="d-block text-muted pt-2 font-size-sm">Data Jalur Pendaftaran</span></h3>
                    </div>
                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <a href="{{ route('admin.jalur-pendaftaran.create') }}" class="btn btn-primary font-weight-bolder">
...
@push('script')
    ...
    <script>
        $(function(){
            ...
            serverSide: true,
            responsive: true,
            ajax: "{{ route('admin.jalur-pendaftaran.index') }}",
            columns: [
                {
                ...
                },
                {
                    ...
                    render: (id) => /* html */`
                            <div class="text-center">
                                <a href="/wpa-admin/jalur-pendaftaran/edit/${id}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
            ...
            $('body').on('click', '.deleteProduct', function () {
                ...
                swalWithBootstrapButtons.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                        method: "GET",
                        url: "/wpa-admin/jalur-pendaftaran" + '/' + product_id,

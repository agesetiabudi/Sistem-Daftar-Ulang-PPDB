            ...
            <div class="card card-custom mb-5">
                <div class="card-header flex-wrap py-5">
                    <div class="card-title">
                        <h3 class="card-label">Banner Cms
                        <span class="d-block text-muted pt-2 font-size-sm">Data Banner</span></h3>
                    </div>
        ...
        <script>
            $(function() {
                Swal.fire({
                    icon: 'success',
                    title: 'Berhasil',
                    text: 'Data yang kamu input sudah di tambahkan',
                });
            });
        </script>
        ...
        <script>
            $(function() {
                Swal.fire({
                    icon: 'success',
                    title: 'Berhasil',
                    text: 'Data yang kamu input sudah di edit',
                });
            });
        </script>
    @endif
    <script>
        $(function(){
            ...
            columns: [
                ...
                {
                    data: 'image',
                    render: function (data, type, row) { return "<img src='/image/banner/"+row.image+"' width='100'>" },
                },
                {
                    data: 'id',
                    render: (id) => /* html */`
                            <div class="text-center">
                                <a href="/banner/edit/${id}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
